...
import com.khylo.salary.calc.IESalaryService2019
import com.khylo.salary.calc.IESalaryService2019
...
class IESalaryService2019Spec extends spock.lang.Specification{
	...
	public void testUscTable() {
		when:
			def exp = bd(0);
			if(a==1)
				exp = IESalaryService2019.uscRates[i][j]
		...
		when:
			exp = bd(0);
			if(s==1)
				exp = IESalaryService2019.uscRatesS[i][j]
		...
		/*		
		assertThat(IESalaryService2019.uscRatesS[0][2], new BigDecimalCloseTo(bd("12012"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[1][2], new BigDecimalCloseTo(bd("5564"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[2][2], new BigDecimalCloseTo(bd("52468"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[3][2], new BigDecimalCloseTo(bd("29956"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[4][2], new BigDecimalCloseTo(bd("99899999"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[0][3], new BigDecimalCloseTo(bd("180.18"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[1][3], new BigDecimalCloseTo(bd("194.74"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[2][3], new BigDecimalCloseTo(bd("3672.76"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[3][3], new BigDecimalCloseTo(bd("2396.48"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.uscRatesS[4][3], new BigDecimalCloseTo(bd("0"), BigDecimal.ZERO));
		
		assertThat(IESalaryService2019.prsiRates[0][2], new BigDecimalCloseTo(bd("18304"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.prsiRates[1][2], new BigDecimalCloseTo(bd("18512"), BigDecimal.ZERO));
		assertThat(IESalaryService2019.prsiRates[2][2], new BigDecimalCloseTo(bd("26000"), BigDecimal.ZERO));

		assertThat(IESalaryService2019.prsiRatesS[0][2], new BigDecimalCloseTo(bd("26000"), BigDecimal.ZERO));*/
	}

	@Unroll("testCalcUsc for Gross #gross and prsi #prsi")
	public void testCalcUsc() {
		given:
			IESalaryService2019 service = new IESalaryService2019();
			Salary s = new Salary();
			s.gross=bd(gross);
			s.prsiClass=prsi;
	...
	public void testCalcPrsiNew() {
		given:
			IESalaryService2019 s2016 = new IESalaryService2019();
	...
	public void calcSalary() {
		given:
			IESalaryService2019 service = new IESalaryService2019();
			SalaryInputParams sip = SalaryInputParams.builder()
					.gross(bd(gross))
					.prsiClass(prsiCls)
					.eligbleForReducedUsc(redUsc)
					.stdRateCutoff(cutoff)
					.taxCredits(bd(credits))
					.build()
			Salary res = service.calcSalary(sip);
		...
		where:  // values cal'ed
			...
			120000 | Prsi.S	| false	 |IESalaryService2019.StdRateCutOffSingle| 3300  || 37640 | 4800 | 7071.43 | 70488.57  // was 67565.84 // see http://ie.thesalarycalculator.co.uk/salary.php
			12000 | Prsi.A	| false	 |IESalaryService2019.StdRateCutOffSingle| 3300  || 0     | 0    |   0     | 12000
			14400 | Prsi.A	| false	 |IESalaryService2019.StdRateCutOffSingle| 3300  || 0     | 0    | 107.82  | 14292.18  //
			120000 | Prsi.A | false	 |IESalaryService2019.StdRateCutOffSingle| 3300  || 37640 | 4800 | 6471.43 | 71088.57
			60000|Prsi.A|false|IESalaryService2019.StdRateCutOffMarried1Income|4950  || 10190 | 2400 | 2022.97 | 45387.03 // was 42115.4
			60000  | Prsi.A	| false	 |IESalaryService2019.StdRateCutOffSingle| 3300  || 13640 | 2400 | 2022.97 | 41937.03
			18000  | Prsi.A	| false	 |IESalaryService2019.StdRateCutOffSingle| 3300  || 300   |  0   | 179.82  | 17520.18 // was 45555.4
