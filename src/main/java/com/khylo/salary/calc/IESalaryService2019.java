...
@Service
@Validated
public class IESalaryService2019 {
	...
	private static String[][] uscS = { 	{".5", "12012"}, // up to 12012
										{"2", "19874"},
										{"4.5", "70044"},
										{"8", "100000"},
										{"11", "99999999"}};
	...
	// Prsi array  {employees %, employer %, max weekly earnings for this band, prsiCredit}
	...
	public static final BigDecimal StdRateCutOffSingle = bd("35300");
	public static final BigDecimal StdRateCutOffSingleParent= bd("39300");
	public static final BigDecimal StdRateCutOffMarried1Income = bd("44300");
	public static final BigDecimal StdRateCutOffMarried2IncomeMax = StdRateCutOffSingle.add(StdRateCutOffSingle);
	public static final BigDecimal StdRateCutOffMarried2IncomeDiff = StdRateCutOffMarried2IncomeMax.subtract(StdRateCutOffMarried1Income);
	public static final BigDecimal StdRateCutOffMarried2IncomesIndependentlyAssessed = null;
	public static final BigDecimal StdRateCutOffMarried2IncomesJointAssesment = null;
	public static final BigDecimal StdRateCutOffMarried2IncomesSingleAssesment = null;
	public static final BigDecimal StdRateCutOffWidowed = null;
