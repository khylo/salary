...
@Service
@Validated
public class IESalaryService2016 {
	...
	private static String[][] uscA = { {"1", "12012"}, // up to 12012
										{"3", "18668"},
										{"5.5", "70044"},
										{"8", "99999999"}};
	
	private static String[][] uscS = { {"1", "12012"},
										{"3", "18668"},
										{"5.5", "70044"},
										{"8", "100000"},
										{"11", "99999999"}};
	
	private static String[][] uscR = { 	{"1", "12012"},   // Reduced usc for MedicalCard holders and those over 70 iff total earnings less than 60000
										{"3", "999999"}};
